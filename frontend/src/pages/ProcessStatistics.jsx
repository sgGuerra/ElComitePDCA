...
const ProcessHeader = ({ process, dateRange, handleDateRangeChange }) => (
...
const KPIList = ({ statistics, getCompletionPercentage, formatDate }) => (
...
const StatisticsCharts = ({ actionsByStatus, actionsByPriority, actionsTrend, CustomTooltip }) => (
...
const PerformanceSummary = ({ process, statistics, getCompletionPercentage, getPriorityLabel }) => (
  ...
  return (
    <div className="min-h-screen bg-lightgray text-primary font-sans p-4 md:p-6 lg:p-8 space-y-6">
      ...
      {error ? (
        ...
        <>
          {/* Header */}
          <ProcessHeader process={process} dateRange={dateRange} handleDateRangeChange={handleDateRangeChange} />
          
          {statistics && (
            <KPIList statistics={statistics} getCompletionPercentage={getCompletionPercentage} formatDate={formatDate} />
          )}
